    ...
    <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                  <div className="bg-neutral-800 text-white text-xs rounded-lg px-2 py-1 whitespace-nowrap">
                    ...
                    <div className="text-neutral-300">{item.students} students</div>
                  </div>
                </div>
              </div>
              <span className="text-sm text-neutral-600 font-medium">{item.month}</span>
            </div>
          );
        })}
      </div>
      ...
      <div className="flex items-center justify-between text-sm text-neutral-600">
        ...
        <div className="text-right">
          <p className="font-medium text-neutral-800">Average Growth</p>
          <p className="text-success-600">+8.3% month over month</p>
        </div>
      </div>
    </div>
  );
