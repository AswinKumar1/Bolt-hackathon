...
const Settings: React.FC = () => {
  ...
  const renderPrivacySection = () => (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Two-Factor Authentication</h3>
        <div className="p-4 bg-success-50 border border-success-200 rounded-lg">
          <div className="flex items-center space-x-3">
            <Check className="w-5 h-5 text-success-600" />
            <div>
              <p className="font-medium text-success-800">Two-factor authentication is enabled</p>
              <p className="text-sm text-success-700">Your account is protected with SMS verification</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Privacy Settings</h3>
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
            <div>
              <p className="font-medium text-neutral-800">Profile Visibility</p>
              <p className="text-sm text-neutral-600">Control who can see your profile information</p>
            </div>
            <select className="px-3 py-1 border border-neutral-300 rounded-lg text-sm">
          ...
          <div className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
            <div>
              <p className="font-medium text-neutral-800">Data Analytics</p>
              <p className="text-sm text-neutral-600">Allow EdTechAI to use your data for analytics</p>
            </div>
  ...
  const renderPaymentSection = () => (
    <div className="space-y-6">
          ...
          <div key={method.id} className="border border-neutral-200 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-2">
                <button className="px-3 py-1 text-sm text-neutral-600 hover:text-neutral-800">
                  Edit
                </button>
      ...
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Billing Information</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Billing Address</label>
            <input
              type="text"
  ...
  const renderSubscriptionSection = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Current Plan</h3>
        <div className="border border-primary-200 bg-primary-50 rounded-lg p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h4 className="text-xl font-bold text-primary-800">Professional Plan</h4>
              <p className="text-primary-700">Perfect for growing educators</p>
            </div>
            <div className="text-right">
              <p className="text-2xl font-bold text-primary-800">$49</p>
      ...
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Billing History</h3>
        <div className="space-y-3">
          {[
            ...
            <div key={index} className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
              <div>
                <p className="font-medium text-neutral-800">{bill.date}</p>
                <p className="text-sm text-neutral-600">Professional Plan</p>
              </div>
              <div className="text-right">
                <p className="font-medium text-neutral-800">{bill.amount}</p>
                <span className="px-2 py-1 bg-success-100 text-success-700 text-xs font-medium rounded-full">
                  {bill.status}
                </span>
              </div>
      ...
      <div className="flex space-x-4">
        ...
        <button className="px-4 py-2 border border-neutral-300 text-neutral-700 rounded-lg hover:bg-neutral-50 transition-all duration-200">
          Cancel Subscription
        </button>
      </div>
    </div>
  ...
  const renderNotificationsSection = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-neutral-800 mb-4">Notification Preferences</h3>
        <div className="space-y-4">
          {[
            ...
            <div key={notification.key} className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
              <div>
                <p className="font-medium text-neutral-800">{notification.label}</p>
                ...
                return (
                  ...
                  >
                    <Icon className={`w-5 h-5 ${
                      activeSection === section.id ? 'text-primary-600' : 'text-neutral-500'
                    }`} />
