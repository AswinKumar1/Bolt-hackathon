  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4">Revenue & Student Growth</h3>
        ...
        >
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4">Course Retention Rates</h3>
            <ResponsiveContainer width="100%" height={300}>
              ...
              {[
                ...
                <div key={index} className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="flex-1">
                    <p className="font-medium text-gray-900">{msg.student}</p>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-green-50 rounded-lg">
                  <div>
                    <h4 className="font-medium text-gray-900">{session.course}</h4>
                    <p className="text-sm text-gray-600">{session.time}</p>
                    <p className="text-xs text-blue-600">{session.students} students enrolled</p>
                  </div>
                  <div className="text-right">
                    <span className="text-sm font-medium text-gray-700">{session.date}</span>
                  </div>
                </div>
              ))}
            </div>
