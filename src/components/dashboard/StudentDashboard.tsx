  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <Card className="p-6">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Continue Learning</h3>
            <div className="space-y-4">
              {courses.map((course) => (
                <div key={course.id} className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                  <img
                    src={course.image}
                    alt={course.title}
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">Next: {course.nextLesson}</p>
          ...
          <Card className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold flex items-center text-gray-900 dark:text-white">
                <Compass className="h-5 w-5 mr-2 text-purple-600 dark:text-purple-400" />
                Suggested for You
              </h3>
            ...
            <div className="space-y-4">
              {suggestedCourses.map((course, index) => (
                <div key={index} className="flex items-center space-x-4 p-4 bg-gradient-to-r from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg">
                  <img
                    src={course.image}
                    alt={course.title}
                    className="w-16 h-16 rounded-lg object-cover"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-1">
                      ...
                      <span className="text-xs text-gray-600 dark:text-gray-300">{course.rating} • {course.students.toLocaleString()} students</span>
                    </div>
                    <div className="mt-1">
            ...
            <div className="space-y-3">
              {achievements.map((achievement, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20 rounded-lg">
                  <achievement.icon className="h-8 w-8 text-yellow-600 dark:text-yellow-400" />
                  <div>
          ...
          <Card className="p-6">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg p-4">
              <div className="flex items-center justify-between mb-3">
                <span className="text-sm font-medium text-gray-700 dark:text-gray-200">Premium Plan</span>
                <span className="bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300 px-2 py-1 rounded-full text-xs">Active</span>
              </div>
              <p className="text-2xl font-bold text-gray-900 dark:text-white mb-1">$79/month</p>
              <p className="text-sm text-gray-600 dark:text-gray-300 mb-4">Renews on March 15, 2024</p>
